...
export const JsonToYamlTool = () => {
  ...
  useRealTimeConversion(jsonInput, () => convertToYaml());
      ...
      <section className="grid md:grid-cols-2 gap-6 pt-6">
        ...
        <div className="bg-white border rounded-xl p-6 shadow-sm">
          ...
          <p className="text-gray-600">
            JSON to YAML conversion transforms JSON data into YAML format.
            YAML is widely used in DevOps tools, configuration files, and cloud systems
        ...
        <div className="bg-white border rounded-xl p-6 shadow-sm">
          ...
          <ul className="space-y-2 text-gray-600">
            ...
            <li>✔ Convert JSON to YAML instantly</li>
            <li>✔ Upload JSON files</li>
            <li>✔ Copy YAML output</li>
